...
print '..... Save NDVI file'
img = geo_image.GeoImage((ndvi, ndvi, ndvi), global_data.area, time_slot, fill_value=(0, 0, 0), mode="RGB")
img.save(outdir + time_slot.strftime('%Y%m%d%H%M') '_ndvi.tif') 
