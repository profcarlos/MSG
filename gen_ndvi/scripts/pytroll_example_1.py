...
for y in range (0, len(bands)):
    ...
    for x in range (1,9):
        ...
        msg_uncompressed_data = outdir + 'H-000-MSG3__-MSG3________-' + bands[y] + '___-00000' + str(x) + '___-' + time_slot.strftime('%Y%m%d%H%M') + '-__'
...
#global_data[0.6].save(outdir + 'msg_band_VIS06.tif')
