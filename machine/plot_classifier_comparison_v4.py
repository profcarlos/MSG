...
inumpyutFile = os.getcwd() + '\\data\\TAB_CLM_perc_1_to_15_ date_20130101_20151231.csv' 

gc.collect()

# DATA = LAT LON BAND_1 BAND_2 BAND_3 BAND_4 BAND_5, BAND_9, CLM
DATA = numpy.loadtxt(inumpyutFile, delimiter = ' ', skiprows = 1, usecols=range(0,10))
#DATA = DATA[1:100]
#print(DATA[0])
...
for i in range (0, cols, 1):
    ...
    X_fit[i] = MinMaxScaler().fit_transform(X_t[i].reshape(-1,1)).transpose()
    #print('X_fit[%d]'%i)
    #print(X_fit[i])
