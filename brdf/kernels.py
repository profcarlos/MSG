...
class Kernels:    
  ...
  def __setup(self,critical=1,RecipFlag=True,RossHS=True,HB=2.2,BR=1.0,MODISSPARSE=True,MODISDENSE=False,RossType='Thick',normalise=1,normalize=0,LiType='Sparse',doIntegrals=True,BSAangles=[],nbar=0.0):
    self.nbar = nbar
