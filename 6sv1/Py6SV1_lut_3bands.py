...
START = [[550, 650, 25, 10], [1000, 1100, 25, 10], [0, 601, 100, 10], [0, 360, 60, 10], [0, 76, 15, 10],[0, 360, 60, 1000], [000, 801, 100, 1000]]
...
class main():
	...
	lut_file = os.getcwd() + '\\LUT_6S_3bands\\LUT_6S_VZA_' + str(VZA) + '.csv'
	num = 0
